...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/8.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">Prohibited Touches Hoodie</h1>
      <p class="price">EGP 1200.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    name: 'Prohibited Touches Hoodie',
    price: 'EGP 1200.00',
    quantity: quantity,
    size: selectedSize,
    code: 'HOODIE005'
