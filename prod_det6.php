...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/14.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">washed Black T</h1>
      <p class="price">EGP 550.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    ...
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(21) 
         : selectedSize === 'M' ? parseInt(22) 
         : selectedSize === 'L' ? parseInt(23) 
         : selectedSize === 'XL' ? parseInt(24) 
         : parseInt(22),
