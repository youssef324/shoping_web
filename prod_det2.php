...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/2.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">Innerdemons hoodie</h1>
      <p class="price">EGP 950.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    name: 'Innerdemons hoodie',
    price: 'EGP 950.00',
    
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(5) 
         : selectedSize === 'M' ? parseInt(6) 
         : selectedSize === 'L' ? parseInt(7) 
         : selectedSize === 'XL' ? parseInt(8) 
         : parseInt(6),
quantity: quantity,
  };
