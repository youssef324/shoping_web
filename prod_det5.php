...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/5.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">Multiple faces T</h1>
      <p class="price">EGP 500.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    name: 'Multiple faces T',
    price: 'EGP 500.00',
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(17) 
         : selectedSize === 'M' ? parseInt(18) 
         : selectedSize === 'L' ? parseInt(19) 
         : selectedSize === 'XL' ? parseInt(20) 
         : parseInt(18),
