...
<body>
    ...
    <div class="button-container">
      ...
      <a href="Profile.php"><button class="button1">
        <svg
          class="icon"
          stroke="currentColor"
          fill="currentColor"
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/1.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>  
      <div class="details-section">
    <h1 id="product-name">Redhell Crewneck</h1>
    <p class="price">EGP 1,000.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    name: 'Redhell Crewneck',
    price: 'EGP 1,000.00',
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(1) 
         : selectedSize === 'M' ? parseInt(2) 
         : selectedSize === 'L' ? parseInt(3) 
         : selectedSize === 'XL' ? parseInt(4) 
         : parseInt(2),
    quantity: quantity, // Use the quantity variable dynamically
  };
