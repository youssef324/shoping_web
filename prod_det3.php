...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/3.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">smookers T</h1>
      <p class="price">EGP 650.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    ...
    price: 'EGP 650.00',
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(9) 
         : selectedSize === 'M' ? parseInt(10) 
         : selectedSize === 'L' ? parseInt(11) 
         : selectedSize === 'XL' ? parseInt(12) 
         : parseInt(10),
    quantity: quantity,
    // Use the quantity variable dynamically
  };
