...
<body>
  ...
  <div class="product-container">
    <div class="image-section">
        ...
        <img src="images/4.png" alt="Hoodie Front" id="main-image" class="main-image">
        <button id="next-image" class="arrow-button right-arrow">➡</button>
      </div>      
    <div class="details-section">
      <h1 id="product-name">Multiple faces Hoodie</h1>
      <p class="price">EGP 1100.00</p>
...
addToCartButton.addEventListener('click', () => {
  const product = {
    name: 'Multiple faces Hoodie',
    price: 'EGP 1100.00',
    
    size: selectedSize,
    code: selectedSize === 'S' ? parseInt(13) 
         : selectedSize === 'M' ? parseInt(14) 
         : selectedSize === 'L' ? parseInt(15) 
         : selectedSize === 'XL' ? parseInt(16) 
         : parseInt(14),
